...
type Tag struct {
	...
	TagLastPulled       time.Time    `json:"tag_last_pulled" bson:"tag_last_pulled"`
	TagLastPushed       time.Time    `json:"tag_last_pushed" bson:"tag_last_pushed"`
...
type ImageInTag struct {
	...
	LastPulled   time.Time `json:"last_pulled" bson:"last_pulled"`
	LastPushed   time.Time `json:"last_pushed" bson:"last_pushed"`
}
