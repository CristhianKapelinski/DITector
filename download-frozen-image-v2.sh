...
# Not supporting all Docker Hub API.
# e.g. bash download-frozen-image-v2.sh library-ubuntu-22.04/ library/ubuntu:22.04,
#  got error: unknown manifest mediaType (library/ubuntu:22.04@22.04): 'application/vnd.oci.image.index.v1+json'
